...
void usb_stor_show_command(const struct us_data *us, struct scsi_cmnd *srb)
{
	...
	case FORMAT_UNIT: what = NULL; break;
	case READ_BLOCK_LIMITS: what = "READ_BLOCK_LIMITS"; break;
	case REASSIGN_BLOCKS: what = "REASSIGN_BLOCKS"; break;
	case READ_6: what = "READ_6"; break;
	case WRITE_6: what = NULL; break;
	case SEEK_6: what = "SEEK_6"; break;
	case READ_REVERSE: what = "READ_REVERSE"; break;
	case WRITE_FILEMARKS: what = NULL; break;
	...
	case WRITE_10: what = NULL; break;
	case SEEK_10: what = "SEEK_10"; break;
	case WRITE_VERIFY: what = NULL; break;
	...
	case WRITE_BUFFER: what = NULL; break;
	case READ_BUFFER: what = "READ_BUFFER"; break;
	case UPDATE_BLOCK: what = "UPDATE_BLOCK"; break;
	case READ_LONG: what = "READ_LONG"; break;
	case WRITE_LONG: what = NULL; break;
	case CHANGE_DEFINITION: what = "CHANGE_DEFINITION"; break;
	case WRITE_SAME: what = NULL; break;
	...
	case WRITE_12: what = NULL; break;
	case WRITE_VERIFY_12: what = "(unknown command)"; break;
	...
	case 0xE1: what = NULL; break;
	case WRITE_LONG_2: what = NULL; break;
	default: what = "(unknown command)"; break;
	}
	usb_stor_dbg1(us, "Command %s (%d bytes)\n", what, srb->cmd_len);
	usb_stor_dbg1(us, "bytes: %*ph\n", min_t(int, srb->cmd_len, 16),
			 ...
			 unsigned char ascq)
{
	...
	if (what == NULL)
        ...
        if (what == "FORMAT_UNIT")
                what = "(Not doing a FORMAT_UNIT)";
        if (what == "WRITE_6")
                what = "(Not doing a WRITE_6)";
        if (what == "WRITE_10")
                what = "(Not doing a WRITE_10)";
        if (what == "WRITE_12")
                what = "(Not doing a WRITE_12)";


	if (fmt)
		usb_stor_dbg1(us, "%s: %s (%s%x)\n", keystr, what, fmt, ascq);
	else
		usb_stor_dbg1(us, "%s: %s\n", keystr, what);
}

void usb_stor_dbg1(const struct us_data *us, const char *fmt, ...)
{
	va_list args;
...
EXPORT_SYMBOL_GPL(usb_stor_dbg1);
