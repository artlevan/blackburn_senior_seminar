...
static int show_info (struct seq_file *m, struct Scsi_Host *host)
{
	...
	seq_printf(m, "   Host scsi%d: usb1-storage\n", host->host_no);
...
void usb_stor_host_template_init1(struct scsi_host_template *sht,
...
EXPORT_SYMBOL_GPL(usb_stor_host_template_init1);

/* To Report "Illegal Request: Invalid Field in CDB */
unsigned char usb_stor_sense_invalidCDB1[18] = {
	[0]	= 0x70,			    /* current error */
	[2]	= ILLEGAL_REQUEST,	    /* Illegal Request = 0x05 */
	[7]	= 0x0a,			    /* additional length */
	[12]	= 0x24			    /* Invalid Field in CDB */
};
EXPORT_SYMBOL_GPL(usb_stor_sense_invalidCDB1);
