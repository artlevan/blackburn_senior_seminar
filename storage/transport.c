 ...
 */
int usb_stor_control_msg1(struct us_data *us, unsigned int pipe,
...
EXPORT_SYMBOL_GPL(usb_stor_control_msg1);
 ...
 */
int usb_stor_clear_halt1(struct us_data *us, unsigned int pipe)
{
	int result;
...
EXPORT_SYMBOL_GPL(usb_stor_clear_halt1);
 ...
 */
int usb_stor_ctrl_transfer1(struct us_data *us, unsigned int pipe,
		u8 request, u8 requesttype, u16 value, u16 index,
		void *data, u16 size)
{
	int result;
...
EXPORT_SYMBOL_GPL(usb_stor_ctrl_transfer1);
 ...
 */
int usb_stor_bulk_transfer_buf1(struct us_data *us, unsigned int pipe,
...
EXPORT_SYMBOL_GPL(usb_stor_bulk_transfer_buf1);
 ...
 */
int usb_stor_bulk_srb1(struct us_data* us, unsigned int pipe,
...
EXPORT_SYMBOL_GPL(usb_stor_bulk_srb1);
 ...
 */
int usb_stor_bulk_transfer_sg1(struct us_data* us, unsigned int pipe,
...
EXPORT_SYMBOL_GPL(usb_stor_bulk_transfer_sg1);
...
int usb_stor_CB_transport1(struct scsi_cmnd *srb, struct us_data *us)
{
...
EXPORT_SYMBOL_GPL(usb_stor_CB_transport1);
...
int usb_stor_Bulk_transport1(struct scsi_cmnd *srb, struct us_data *us)
{
...
EXPORT_SYMBOL_GPL(usb_stor_Bulk_transport1);
...
int usb_stor_CB_reset1(struct us_data *us)
{
...
EXPORT_SYMBOL_GPL(usb_stor_CB_reset1);

/*
 * This issues a Bulk-only Reset to the device in question, including
 * clearing the subsequent endpoint halts that may occur.
 */
int usb_stor_Bulk_reset1(struct us_data *us)
{
	return usb_stor_reset_common(us, US_BULK_RESET_REQUEST, 
				 USB_TYPE_CLASS | USB_RECIP_INTERFACE,
				 0, us->ifnum, NULL, 0);
}
EXPORT_SYMBOL_GPL(usb_stor_Bulk_reset1);
